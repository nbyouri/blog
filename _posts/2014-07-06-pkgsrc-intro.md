...
You should have a copy of the pkgsrc tree sitting somewhere on your disk, already bootstrapped, see my [blog post](http://saveosx.org/pkgsrc-bootstrap/) about it. 
