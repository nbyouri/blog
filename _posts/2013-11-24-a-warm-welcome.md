...
All the binaries available on our repo are 64bit too, [see for yourself!](http://pkgsrc.saveosx.org/Darwin/2013Q4/x86_64/)
...
For now, if you want to try out some packages, use [our pkgin boostrap](http://pkgsrc.saveosx.org/Darwin/bootstrap/bootstrap-x86_64-2013Q4.pkg) and get  testing!
